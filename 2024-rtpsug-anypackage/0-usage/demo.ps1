...
Remove-Module AnyPackage.Chocolatey, AnyPackage.ModuleFast, AnyPackage.DotNet.Tool -ErrorAction SilentlyContinue
Get-PackageProvider
...
# Version scheme sorting rules
# AlphaNumeric > MultiPartNumericSuffix >
# MultiPartNumeric / SemanticVersion > Integer > SemanticVersion prerelease
...
$provider = Get-PackageProvider -Name PSResourceGet
$provider
$provider.Priority = 0
$provider
Get-PackageProvider -Name PSResourceGet
...
Find-Package -
Find-Package -Provider PSResourceGet -

# Command not found feedback provider and command predictor
vim
Start-Log
